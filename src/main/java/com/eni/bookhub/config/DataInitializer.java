...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String @NonNull ... args) {
        ...
        List<Book> books = List.of(
                ...
                Book.builder().title("Madame Bovary").lastName("Flaubert").firstName("Gustave").isbn("009-2070413149").category("Drame").status("UNAVAILABLE").frontCoverImg("https://example.com/covers/madame-bovary.jpg").copyNumber(3).build(),
